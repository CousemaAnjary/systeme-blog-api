...
import { Dialog, DialogContent, DialogFooter, DialogHeader, DialogTitle, DialogClose, } from "@/components/ui/dialog"; // Correct the import path if necessary
        ...
        <div>
            <div className="bg-white p-4 rounded-lg shadow-md mb-4" >
                <div className="flex items-center space-x-4">
                    ...
                    <input type="text" placeholder={`Quoi de neuf, ${user.firstname} ?`} className="flex-1 bg-gray-100 rounded-full px-4 py-2 outline-none cursor-pointer" readOnly onClick={openModal} />
                </div>
            ...
            <Dialog open={isOpen} onOpenChange={closeModal}>
                <DialogContent>
                    ...
                    <div className="p-4">
                        ...
                        <textarea placeholder={`Quoi de neuf, ${user.firstname} ?`} className="w-full h-24 bg-gray-100 rounded-lg p-2 outline-none mb-4" />
                        ...
                        <div className="flex justify-between mt-4">
                            <button className="flex items-center space-x-2 text-gray-400 hover:text-blue-500 mb-2">
                                <Video size={20} />
                                <span>Vidéo en direct</span>
                            </button>

                            <button className="flex items-center space-x-2 text-gray-400 hover:text-yellow-500 mb-2">
                                <Smile size={20} />
                                <span>Humeur/activité</span>
                            </button>
                        </div>
                    ...
                    <DialogFooter>
                        <button className="bg-blue-500 w-full text-white px-4 py-2 rounded-lg" onClick={closeModal}>Publier</button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
        </div>
